...
class ModelConfig:
    ...
    def __init__(self,
        ...
        self.max_model_len= min(self.max_model_len, 16384) # Cautious
...
class ContrastiveDecodingConfig:
    ...
    def maybe_create_cd_config(
        ...
        cd_positive_model1: Optional[str],
        cd_negative_model1: Optional[str],
        cd_positive_model2: Optional[str],
        cd_negative_model2: Optional[str],
        ...
        positive_model_config1 = None
        negative_model_config1 = None
        if cd_positive_model1 is not None:
            positive_model_config1 = ModelConfig(
                model=cd_positive_model1,
                task="generate",
                tokenizer=base_model_config.tokenizer,
                tokenizer_mode=base_model_config.tokenizer_mode,
                trust_remote_code=base_model_config.trust_remote_code,
        ...
        if cd_negative_model1 is not None:
            negative_model_config1 = ModelConfig(
                model=cd_negative_model1,
                task="generate",
                tokenizer=base_model_config.tokenizer,
                tokenizer_mode=base_model_config.tokenizer_mode,
                trust_remote_code=base_model_config.trust_remote_code,
        ...
        positive_model_config2 = None
        negative_model_config2 = None
        if cd_positive_model2 is not None:
            positive_model_config2 = ModelConfig(
                model=cd_positive_model2,
                task="generate",
                tokenizer=base_model_config.tokenizer,
                tokenizer_mode=base_model_config.tokenizer_mode,
                trust_remote_code=base_model_config.trust_remote_code,
        ...
        if cd_negative_model2 is not None:
            negative_model_config2 = ModelConfig(
                model=cd_negative_model2,
                task="generate",
                tokenizer=base_model_config.tokenizer,
                tokenizer_mode=base_model_config.tokenizer_mode,
                trust_remote_code=base_model_config.trust_remote_code,
        ...
        return ContrastiveDecodingConfig(
            ...
            positive_model_config1,
            negative_model_config1,
            positive_model_config2,
            negative_model_config2,
    ...
    def __init__(self,
        ...
        self.positive_model_config1 = positive_model_config1
        self.negative_model_config1 = negative_model_config1
        self.positive_model_config2 = positive_model_config2
        self.negative_model_config2 = negative_model_config2
