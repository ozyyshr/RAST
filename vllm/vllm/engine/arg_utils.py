...
class EngineArgs:
    ...
    # Siru: Contrastive Decoding configuration.
    cd_positive_model: Optional[str] = None
    cd_negative_model: Optional[str] = None
    cd_decoding_alpha: Optional[float] = None
    cd_positive_model1: Optional[str] = None
    cd_negative_model1: Optional[str] = None
    cd_positive_model2: Optional[str] = None
    cd_negative_model2: Optional[str] = None
    ...
    def create_engine_config(self) -> EngineConfig:
        ...
        contrastive_decoding_config = ContrastiveDecodingConfig.maybe_create_cd_config(
            ...
            cd_positive_model1=self.cd_positive_model1,
            cd_negative_model1=self.cd_negative_model1,
            cd_positive_model2=self.cd_positive_model2,
            cd_negative_model2=self.cd_negative_model2,
